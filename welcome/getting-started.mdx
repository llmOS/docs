...
For example, you can create an AWS CLI Copilot using the following code by adding it to a `copilot.py` file.
Make sure to replace `openai_api_key` with your 🔑 own [OpenAI API key](https://platform.openai.com/account/api-keys).
...
### 5. Create your own custom Copilot

* [Start developing your copilot here](/create/) by prompting, adding knowledge base to context, etc.
