...
Introduced in the [v0.3.3](https://github.com/opencopilotdev/opencopilot/releases/tag/v0.3.3) release, the CLI includes a helpful `retrieve` command that lets you debug the [knowledge base](/improve/knowledge-base) from various angles.
...
╭─ Options ────────────────────────────────────────────────────────────────╮
│ --text    -t      TEXT  Your question, i.e. "How to improve retrieval?"  │
│                         [default: None]                                  │
