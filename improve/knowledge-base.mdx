...
If you are using Windows, then you will need to set up Weaviate vector store manually. Click to see the instructions below:

<Accordion title="Setting up Weaviate on Windows">
