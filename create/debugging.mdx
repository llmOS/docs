...
We recommend keeping the debug view enabled while you're developing your copilot. It will help you understand what's going on under the hood, and tell you whether you should be improving the [prompt](/create/prompting), adding documents to the [knowledge base](/create/knowledge-base), or anything else.